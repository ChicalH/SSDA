...
Workdir = '/checkpoints/iter_40000.pth'##
...
def parse_args():
    ...
    parser.add_argument('--config',default=Workdir+Workdir.split('/')[-2]+'.json',
    help='test config file path')
    parser.add_argument('--checkpoint', default=Workdir+'iter_40000.pth',help='checkpoint file')
    parser.add_argument(
